import 'package:fish_farm_app/screens/home_screen.dart';
            ...
            child: Column(
              children: [
                ...
                Text("Khyber Pakhtunkhwa\n"
                    "Fisheries Department",style: TextStyle(fontSize: 25,fontWeight: FontWeight.bold,
                color: Color(0xFF1F5E3C),

                ),),
                // ---------------- CURVED GREEN AREA ----------------
                SizedBox(
                  height: MediaQuery.of(context).size.height * 0.75, // keep 75% height
                  child: Stack(
                    children: [
                      ClipPath(
                                    ...
                                    child: Row(
                                      children: [
                                        Checkbox(
                                          ...
                                          checkColor: Color(0xFF1F5E3C), // white tick
                                          fillColor: MaterialStateProperty.resolveWith((states) {
                                            return states.contains(MaterialState.selected)
                                                ? const Color(0xFFFFFFFF) // green when checked
                                        ...
                                        const Text('Remember me', style: TextStyle(fontSize: 15, color: Colors.white)),
                                        const Spacer(),
                                        const Text(
                                          "Forgot Password?",
                                          style: TextStyle(
